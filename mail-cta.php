<?php
/**
 * mail-cta.php — GALAXY demo enquiry handler (bottom CTA form)
 * Accepts POST from the final CTA form on goodsystems.html
 */
...
$body  = "New GALAXY demo enquiry (CTA form) via goodsystems.html\n\n";
$body .= "Name:          {$name}\n";
